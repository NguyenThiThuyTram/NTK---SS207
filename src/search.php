...
<style>
    ...
    /* =========================================
   GIAO DIỆN THANH TÌM KIẾM ĐẸP (ELEGANT SEARCH BAR)
   ========================================= */
.search-bar-container {
    ...
    padding: 25px 5%;
    box-shadow: 0 10px 15px rgba(0,0,0,0.05); /* Đổ bóng nhẹ cho sang */
    z-index: 999;
...
.search-form {
    display: flex;
    align-items: center;
    max-width: 700px; /* Độ rộng vừa phải, canh giữa */
    margin: 0 auto;
    border-bottom: 2px solid #2f1c00; /* Chỉ có 1 đường viền mảnh màu nâu đen ở dưới cùng */
    padding-bottom: 8px;
}

/* Ẩn viền và nền của các nút bấm */
...
.submit-search:hover i { transform: scale(1.1); } /* Hover kính lúp to lên xíu */

/* Tùy chỉnh ô nhập liệu */
.search-form input {
    flex: 1;
    border: none; /* Xóa viền đen xấu xí */
    outline: none; /* Xóa viền xanh khi click chuột */
    font-size: 16px;
    padding: 10px 0;
...
/* Nút X màu xám, di chuột vào đỏ lên */
.close-search i {
    font-size: 24px;
    color: #999;

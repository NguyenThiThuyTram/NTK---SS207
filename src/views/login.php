    ...
    <div id="modal-overlay" class="modal-overlay">
        <div class="login-box">
            ...
            <form action="../controllers/loginController.php" method="POST">
                ...
                <?php 
                    $redirect_url = '../index.php'; // Mặc định sẽ về trang chủ
                    ...
                    if (isset($_GET['redirect'])) {
                        ...
                        // BỘ LỌC THÔNG MINH: Quên đi những trang hệ thống, chỉ nhớ trang xem hàng
                        if (strpos($referer, 'Controller') === false && 

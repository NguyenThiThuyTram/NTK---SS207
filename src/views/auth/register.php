...
<body>
    ...
    <script>
        // Báo cho JS biết ô mật khẩu và con mắt nằm ở đâu
        const toggleEye = document.getElementById('toggleEye');
        const passwordInput = document.getElementById('myPassword');

        // Lắng nghe hành động "click" vào con mắt
        toggleEye.addEventListener('click', function () {
            // Nếu type đang là password (ẩn) thì đổi thành text (hiện), và ngược lại
            const type = passwordInput.getAttribute('type') === 'password' ? 'text' : 'password';
            passwordInput.setAttribute('type', type);
            
            // Làm mờ con mắt đi một xíu khi đang hiện mật khẩu cho đẹp
